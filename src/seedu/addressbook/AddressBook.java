...
public class AddressBook {
    ...
    /* We use a HashMap to store the details of a single person.
     ...
     */
    private static final ArrayList<Map<String, String>> ALL_PERSONS = new ArrayList<>();
     ...
     */
    private static ArrayList<Map<String, String>> latestPersonListingView = getAllPersonsInAddressBook(); // initial
    // view is of all
    ...
    private static String executeAddPerson(String commandArgs) {
        ...
        final Optional<Map<String, String>> decodeResult = decodePersonFromString(commandArgs);
        ...
        final Map<String, String> personToAdd = decodeResult.get();
     ...
     */
    private static String getMessageForSuccessfulAddPerson(Map<String, String> addedPerson) {
    ...
    private static String executeFindPersons(String commandArgs) {
        ...
        final ArrayList<Map<String, String>> personsFound = getPersonsWithNameContainingAnyKeyword(keywords);
     ...
     */
    private static String getMessageForPersonsDisplayedSummary(ArrayList<Map<String, String>> personsDisplayed) {
     ...
     */
    private static ArrayList<Map<String, String>> getPersonsWithNameContainingAnyKeyword(Collection<String> keywords) {
        final ArrayList<Map<String, String>> matchedPersons = new ArrayList<>();
        for (Map<String, String> person : getAllPersonsInAddressBook()) {
    ...
    private static String executeDeletePerson(String commandArgs) {
        ...
        final Map<String, String> targetInModel = getPersonByLastVisibleIndex(targetVisibleIndex);
     ...
     */
    private static String getMessageForSuccessfulDelete(Map<String, String> deletedPerson) {
    ...
    private static String executeListAllPersonsInAddressBook() {
        ArrayList<Map<String, String>> toBeDisplayed = getAllPersonsInAddressBook();
    ...
    */
     ...
     *
     */
    private static void showToUser(ArrayList<Map<String, String>> persons) {
     ...
     */
    private static String getDisplayString(ArrayList<Map<String, String>> persons) {
        final StringBuilder messageAccumulator = new StringBuilder();
        for (int i = 0; i < persons.size(); i++) {
            final Map<String, String> person = persons.get(i);
     ...
     */
    private static String getIndexedPersonListElementMessage(int visibleIndex, Map<String, String> person) {
     ...
     */
    private static String getMessageForFormattedPersonData(Map<String, String> person) {
     ...
     */
    private static void updateLatestViewedPersonListing(ArrayList<Map<String, String>> newListing) {
     ...
     */
    private static Map<String, String> getPersonByLastVisibleIndex(int lastVisibleIndex) {
     ...
     */
    private static ArrayList<Map<String, String>> loadPersonsFromFile(String filePath) {
        final Optional<ArrayList<Map<String, String>>> successfullyDecoded = decodePersonsFromStrings(getLinesInFile(
                filePath));
     ...
     */
    private static void savePersonsToFile(ArrayList<Map<String, String>> persons, String filePath) {
     ...
     * @param person to add
     */
    private static void addPersonToAddressBook(Map<String, String> person) {
     ...
     */
    private static boolean deletePersonFromAddressBook(Map<String, String> exactPerson) {
     ...
     */
    private static ArrayList<Map<String, String>> getAllPersonsInAddressBook() {
        return ALL_PERSONS;
    }
     ...
     */
    private static void initialiseAddressBookModel(ArrayList<Map<String, String>> persons) {
        ALL_PERSONS.clear();
     ...
     */
    private static String getNameFromPerson(Map<String, String> person) {
     ...
     */
    private static String getPhoneFromPerson(Map<String, String> person) {
     ...
     */
    private static String getEmailFromPerson(Map<String, String> person) {
     ...
     */
    private static Map<String, String> makePersonFromData(String name, String phone, String email) {
     ...
     */
    private static String encodePersonToString(Map<String, String> person) {
     ...
     */
    private static ArrayList<String> encodePersonsToStrings(ArrayList<Map<String, String>> persons) {
     ...
     */
    private static Optional<Map<String, String>> decodePersonFromString(String encoded) {
        // check that we can extract the parts of a person from the encoded string
        if (!isPersonDataExtractableFrom(encoded)) {
            return Optional.empty();
        }
        final Map<String, String> decodedPerson = makePersonFromData(
     ...
     */
    private static Optional<ArrayList<Map<String, String>>> decodePersonsFromStrings(ArrayList<String> encodedPersons) {
        final ArrayList<Map<String, String>> decodedPersons = new ArrayList<>();
        for (String encodedPerson : encodedPersons) {
            final Optional<Map<String, String>> decodedPerson = decodePersonFromString(encodedPerson);
     ...
     */
    private static boolean isPersonDataValid(Map<String, String> person) {
