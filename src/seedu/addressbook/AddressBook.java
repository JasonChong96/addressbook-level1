...
public class AddressBook {
     ...
     * The Enum given below are the keys for the different data elements of a person
     ...
     */
    private static ArrayList<Map<PersonProperty, String>> latestPersonListingView = getAllPersonsInAddressBook(); // initial
    // view is of all
    ...
    */
    ...
    private static ArrayList<Map<PersonProperty, String>> loadPersonsFromFile(String filePath) {
        final Optional<ArrayList<Map<PersonProperty, String>>> successfullyDecoded = decodePersonsFromStrings(getLinesInFile(
                filePath));
